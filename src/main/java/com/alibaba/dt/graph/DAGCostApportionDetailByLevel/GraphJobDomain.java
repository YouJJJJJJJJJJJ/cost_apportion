...
public class GraphJobDomain {
    ...
    public final Text MSG_NODE_LIST = new Text("msg.node.list");
    public final Text NODE_ANCESTOR_APPORTION_MAP = new Text("node.ancestor.apportion.map");
    ...
    public final Text NODE_COST = new Text("node.cost");
    ...
    public final Text EDGE_WEIGHT = new Text("edge.weight");
    ...
    public final Text NODE_PARENT_CNT = new Text("node.parent.cnt");
    public final Text NODE_MSG_CNT = new Text("node.msg.cnt");
